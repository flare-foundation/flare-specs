...
| [MachineReplication](MachineReplication.md) | Replace a TEE machine's enclave while preserving its $\mathrm{TEE}_\mathrm{ID}$. | [Machines § Statuses](../Concepts/Machines.md#statuses) |
