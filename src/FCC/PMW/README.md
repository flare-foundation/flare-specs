...
Users submit transactions from that wallet by issuing an instruction on Flare Confidential Compute; the wallet's keys live in TEE machines registered to the [system extension](../FCE/System.md), and Flare's [data providers](../../Terminology/Roles.md#data-provider) bridge information between Flare, the TEE network, and the external chain.
