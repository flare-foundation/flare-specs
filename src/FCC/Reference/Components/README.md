...
Each [TEE operator](../../../Terminology/Roles.md#tee-operator) runs one TEE machine paired with one TEE proxy; each [data provider](../../../Terminology/Roles.md#data-provider) or [cosigner](../../Concepts/Instructions.md#cosigners) runs a relay client.

| Page | Role |
|---|---|
| [TEE Machine](Machine.md) | The enclave that processes actions and signs results. |
