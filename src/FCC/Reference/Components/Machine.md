...
A _TEE machine_ is a confidential-compute environment that runs an [FCE](../../FCE/README.md)'s code inside a hardware-attested enclave (Intel TDX, AMD SEV, etc.) on a cloud TEE platform.
