...
JSON types carried in policy direct actions ([`INITIALIZE_POLICY`](../../Operations/F_POLICY.md#initialize_policy), [`UPDATE_POLICY`](../../Operations/F_POLICY.md#update_policy)).
