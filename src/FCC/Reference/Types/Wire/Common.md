...
Over HTTP, ECDSA signatures are represented as a single hex string carrying the 65 signature bytes in Flare's [off-chain convention](../../../../Utilities/Signing.md#encoding-conventions).
