...
Extension ID $0$ is reserved for the [system extension](SystemExtension.md), which hosts FCC's PMW and FDC2 applications; custom extensions use IDs greater than $0$.
...
- `supportedCodeHashes`: The set of code hashes (Docker images) that registered [TEE machines](../Components/TeeMachine.md) may run.
