...
FDC2 is a TEE-based variant of the [FDC](../../../FDC/Introduction.md), implemented as an application on the [system extension](../SystemExtension.md) and managed via the `Fdc2Hub` smart contract.
...
The signed attestation is served by the [TEE proxy](../../Components/TeeProxy.md) and can be published on Flare.
...
| [Commands](Commands/README.md) | The `F_FDC2 PROVE` command. |
