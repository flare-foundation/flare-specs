...
2. **[Data providers](../Terminology/Roles.md#data-provider) and [cosigners](Operations/Instructions.md#cosigners)**: Each run a [relay client](Reference/Components/RelayClient.md) that monitors the Flare C-chain for [instruction events](Operations/Instructions.md#sending-instructions).
