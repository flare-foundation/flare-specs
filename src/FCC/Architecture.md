...
3. **[TEE machines](Concepts/Machines.md)** — confidential VMs that execute [actions](Concepts/Actions.md) derived from relayed instructions or from [direct actions](Concepts/Actions.md#direct-actions), and sign the result with either their [identity key](Concepts/Machines.md#identity) or a [wallet key](Concepts/Keys.md).
