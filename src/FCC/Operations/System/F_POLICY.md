...
[Direct actions](../Actions.md#direct-actions) issued by the [TEE proxy](../../Components/TeeProxy.md) to install and rotate the active [signing policy](../../../FSP/SigningPolicy.md) on the machine.
...
- On success, the proxy's [result hooks](../../Components/TeeProxy.md#result-hooks) enqueue a [`TEE_BACKUP`](F_GET.md#tee_backup) for every stored key, binding fresh backups to the new policy.
