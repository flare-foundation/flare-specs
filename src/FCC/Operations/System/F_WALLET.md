...
[Instruction actions](../Actions.md#instruction-actions) that manage wallet-stored private keys on TEE machines: generation, deletion, restoration from backup, and VRF proof production.
