...
An _operation_ is a piece of work a [TEE machine](../Reference/Components/Machine.md) performs, identified by an `(opType, opCommand)` pair (e.g. `F_WALLET KEY_GENERATE`).
System operations carry the `F_` op-type prefix and are handled by every TEE machine regardless of [FCE](../FCE/README.md); custom operations are defined by individual FCEs.
...
| [System](../Reference/Operations/README.md) | Reference for each system `(opType, opCommand)` pair, organized by op-type. |
...
For the off-chain participants that implement this flow, see [Components](../Reference/Components/README.md).
For extension-app commands that live outside this directory, see [PMW commands](../PMW/Reference/Operations/README.md) and [FDC2 commands](../FDC2/Reference/Operations/README.md).
