...
| Page | Role |
|---|---|
| [TEE Machine](TeeMachine.md) | The confidential VM that processes actions and signs results. |
| [TEE Proxy](TeeProxy.md) | The proxy server in front of the TEE machine; collects votes, queues actions, exposes the external API. |
