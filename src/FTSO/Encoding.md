...
The `CommitHash` is generated by applying the keccak256 hash function to the abi-encoded tuple `(submitAddress, round, random, feedValues)`.

## Reveal

| **Field**   | **Size (bytes)** | **Description**                     |
| ----------- | ---------------- | ----------------------------------- |
| RandomValue | 32               | keccak256 hash (big-endian).        |
