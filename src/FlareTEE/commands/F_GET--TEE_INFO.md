...
Calculates TEE attestation for a given challenge and returns the attestation result. This is a direct [action](../Operations/Actions.md) triggered by the [TEE proxy](../TeeManagement/TeeProxy.md) without any signatures.
