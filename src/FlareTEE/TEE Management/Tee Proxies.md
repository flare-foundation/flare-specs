...
Direct actions are created internally by the proxy for [`TEE_INFO`](../commands/F_GET--TEE_INFO.md), [`KEY_INFO`](../commands/F_GET--KEY_INFO.md), [`UPDATE_POLICY`](../commands/F_POLICY--UPDATE_POLICY.md), and [`TEE_BACKUP`](../commands/F_GET--TEE_BACKUP.md) operations. 
