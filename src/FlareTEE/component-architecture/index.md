...
| [Verifier Server](go-verifier-api.md) | FDC2 verifier server that validates attestation requests. Each attestation type is loaded as a module with its own verification logic. |
