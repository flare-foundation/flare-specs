...
More details can be found [here](Projects.md).
...
In order to ensure keys are not inaccessible or lost in instances where TEEs are either temporarily or permanently disabled, keys are securely [backed up](KeyManagement.md) using a secret sharing scheme.
