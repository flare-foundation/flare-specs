...
For the on-chain data model — projects, wallets, admins, cosigners, multisig thresholds, and the wallet lifecycle — see [Wallets](../FCC/Concepts/Wallets.md).
...
2. Each data provider builds and signs the corresponding instruction off-chain through its [relay client](../FCC/Reference/Components/RelayClient.md), then submits it to the targeted [TEE proxies](../FCC/Reference/Components/Proxy.md).
