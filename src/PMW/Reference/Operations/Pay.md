...
[`PaymentInstructionMessage`](../Types/Payment.md#paymentinstructionmessage), referencing [`TeeIdKeyIdPair`](../../../FCC/Reference/Types/Abi/Common.md#teeidkeyidpair).
...
- `submissionTag = threshold`: empty data, [`ActionResult.status`](../../../FCC/Concepts/Actions.md#action-results) = $2$ (in-progress).
